...
- Métodos de pandas consultados en la documentación oficial: [`rename_axis`](https://pandas.pydata.org/docs/reference/api/pandas.Series.rename_axis.html), [`to_frame`](https://pandas.pydata.org/docs/reference/api/pandas.Series.to_frame.html), [`nlargest`](https://pandas.pydata.org/docs/reference/api/pandas.Series.nlargest.html), [`map`](https://pandas.pydata.org/docs/reference/api/pandas.Series.map.html), [`isin`](https://pandas.pydata.org/docs/reference/api/pandas.Series.isin.html) y [`GroupBy.size`](https://pandas.pydata.org/docs/reference/api/pandas.core.groupby.DataFrameGroupBy.size.html).
- De matplotlib: [`bar_label`](https://matplotlib.org/stable/api/_as_gen/matplotlib.axes.Axes.bar_label.html).
- De networkx: [`circular_layout`](https://networkx.org/documentation/stable/reference/generated/networkx.drawing.layout.circular_layout.html), [`get_edge_attributes`](https://networkx.org/documentation/stable/reference/generated/networkx.classes.function.get_edge_attributes.html) y [`draw_networkx_edge_labels`](https://networkx.org/documentation/stable/reference/generated/networkx.drawing.nx_pylab.draw_networkx_edge_labels.html).
